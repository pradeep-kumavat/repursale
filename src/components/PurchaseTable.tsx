  ...
  useEffect(() => {
    const fetchBuyers = async () => {
      ...
      try {
        ...
        // Filter buyers whose type is "purchase"
        const purchaseBuyers = response.data.filter((buyer: Buyer) => buyer.type.toLowerCase() === "purchase");
        setBuyers(purchaseBuyers);
      } catch (err: unknown) {
        ...
        <div className="flex justify-center items-center min-h-screen">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-white mb-4">
              Please sign in to view your purchase data
            </h2>
